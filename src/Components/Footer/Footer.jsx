...
export default function Footer() {
  ...
  <div className="bg-gray-100 mt-5">
    <div className="max-w-screen-lg px-4 sm:px-6 text-gray-800 sm:grid md:grid-cols-4 sm:grid-cols-2 mx-auto">
      <div className="p-5">
        <h3 className="font-bold text-xl text-green-500">Fresh Cart</h3>
      </div>
      <div className="p-5">
        <div className="text-sm uppercase text-green-500 font-bold">Resources</div>
      ...
      <div className="p-5">
        <div className="text-sm uppercase text-green-500 font-bold">Support</div>
      ...
      <div className="p-5">
        <div className="text-sm uppercase text-green-500 font-bold">Contact us</div>
