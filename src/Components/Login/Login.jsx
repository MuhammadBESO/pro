...
<div className="w-full  shadow-md  dark:bg-gray-800 rounded-lg  px-10 py-4   flex flex-col items-center">
    <h1 className="text-4xl font-semibold me-auto text-green-500  dark:text-gray-200 mb-5">Login In</h1>
   ...
   <Link to={"/forgettenpassword"} className="font-bold text-xl">ForgettenPassword? </Link>

   </div>
   <button type="submit" className=" mb-4 font-medium lg:border-green-600 lg:border lg:px-8 lg:py-3 p-2 lg:bg-transparent rounded-md bg-green-600 text-white lg:text-green-600 duration-100  hover:bg-green-600 uppercase hover:text-white">loin now</button>
